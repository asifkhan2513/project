...
//       <div className="flex space-x-6 end bg-cyan-600 text-white">
//         <Plus /> <Import /> <FolderInput />
//       </div>
...
//       {/* Action Buttons */}
//       <div className="flex space-x-6 bg-cyan-600 text-white p-3 rounded mb-4">
...
//                 <td className="px-6 py-4">{emp?.jobInfo?.branch ?? "-"}</td>
//                 <td className="px-6 py-4">{emp?.jobInfo?.department ?? "-"}</td>
//                 <td className="px-6 py-4">{emp?.jobInfo?.designation ?? "-"}</td>
//                 <td className="px-6 py-4">
//                   {emp?.jobInfo?.joiningDate
//                     ? new Date(emp.jobInfo.joiningDate).toLocaleDateString(
//                         "en-US",
...
//                   <textarea placeholder="Address*" className="w-full border p-2 rounded"></textarea>
//                 </div>
//               </div>
...
//                 <div className="space-y-3">
//                   <input type="text" value="ID" readOnly className="w-full border p-2 rounded bg-gray-100" />
...
//                 <div className="space-y-3">
//                   {["Adhar Card*", "Pan Card*", "Photos*", "Bank Account*", "Police Verification*"].map((doc, i) => (
...
//                 <div className="space-y-3">
//                   <input type="text" placeholder="Account Holder Name" className="w-full border p-2 rounded" />
//                   <input type="text" placeholder="Account Number" className="w-full border p-2 rounded" />
//                   <input type="text" placeholder="Bank Name" className="w-full border p-2 rounded" />
//                   <input type="text" placeholder="Bank Identifier Code" className="w-full border p-2 rounded" />
//                   <input type="text" placeholder="Branch Location" className="w-full border p-2 rounded" />
//                   <input type="text" placeholder="Tax Payer Id" className="w-full border p-2 rounded" />
//                 </div>
//               </div>
//             </form>
